 ...
 ******************************************************/
static const cy_wcm_ip_setting_t sta_ip_addr =
{
    INITIALISER_IPV4_ADDRESS1(.ip_address, MAKE_IPV4_ADDRESS1(192, 168, 1, 13)),
    INITIALISER_IPV4_ADDRESS1(.netmask, MAKE_IPV4_ADDRESS1(255, 255, 255, 0)),
    INITIALISER_IPV4_ADDRESS1(.gateway, MAKE_IPV4_ADDRESS1(192, 168, 1, 1)),
};
...
cy_rslt_t wifi_connect(void)
{
    ...
    if (CY_RSLT_SUCCESS == result)
    {
        ...
        APP_INFO(("Join to AP: %s, security is %d\n", connect_param.ap_credentials.SSID, connect_param.ap_credentials.security));
