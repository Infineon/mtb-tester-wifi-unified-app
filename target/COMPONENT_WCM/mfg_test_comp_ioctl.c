 ...
 ******************************************************/
extern cy_rslt_t cywifi_set_iovar_value( const char *iovar, uint32_t value );
extern cy_rslt_t cywifi_set_ioctl_value( uint32_t ioctl, uint32_t value);
extern cy_rslt_t cywifi_set_ioctl_buffer( uint32_t ioctl, uint8_t *buffer, uint16_t len);
extern cy_rslt_t cywifi_get_iovar_value( const char *iovar, uint32_t *value );
extern cy_rslt_t cywifi_get_ioctl_buffer( uint32_t ioctl, uint8_t *buffer, uint16_t len);
extern cy_rslt_t cywifi_get_ioctl_value( uint32_t ioctl, uint32_t *value);
...
#if 0 /* The following functions are already defined in wifi_cert_api.c
/*
