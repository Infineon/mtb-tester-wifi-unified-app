 ...
 *    TARGET_CY8CKIT-062S2-43012.lib : https://github.com/Infineon/TARGET_CY8CKIT-062S2-43012/#latest-v2.X
 *    freertos.lib : https://github.com/Infineon/freertos/#latest-v10.X
 *
 *    # MTB2.2 and .mtb approach
 *    echo https://github.com/Infineon/TARGET_CY8CKIT-062S2-43012#latest-v2.X#\$\$ASSET_REPO\$\$/TARGET_CY8CKIT-062S2-43012/latest-v2.X > deps/TARGET_CY8CKIT-062S2-43012.mtb
 ...
 *    git clone https://github.com/Infineon/afr-example-wlan-lowpower.git
 ...
 *    the LPA middleware :
 *    \code
 *    mbed add https://github.com/Infineon/lpa/
 *    mbed add https://github.com/Infineon/connectivity-utilities
 *    mbed deploy
 *    \endcode
 *
 ...
 *    \code
 *    git clone https://github.com/Infineon/mtb-example-anycloud-wlan-lowpower.git
 ...
 *    git clone https://github.com/Infineon/amazon-freertos.git --recurse-submodules
 *    cd amazon-freertos/projects/cypress/
 *    git clone https://github.com/Infineon/afr-example-wlan-offloads.git
 ...
 *    \code
 *    git clone https://github.com/Infineon/mtb-example-anycloud-offload-tcp-keepalive.git
 ...
 *    example directory:
 *    \code
 *    git clone https://github.com/Infineon/mtb-example-anycloud-ble-wifi-onboarding.git
